    	...
    	foreach($rows as $row){
    		...
    		$row_str.='<tr class="'.$attb.'"> ';
    				$i=0;
		  			...
		  			if($delete==3 || $delete==4){
		  				$row_str .= '<td align="center"><a style="cursor: pointer;"  onclick="showDeleteForm('.$temp.')" ><img style="vertical-align: middle; padding: 0 5px;" src="'.BASE_URL.'/images/delete.png" />'.$tr->translate("DELETE").'</a></button></td>';
		  			}
 			$row_str.='</tr>';
    	}
